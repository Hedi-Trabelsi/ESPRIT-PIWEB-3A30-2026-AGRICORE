...
{
    // --- FRONT-END (formerly HomeController) ---
    ...
    public function maintenanceFront(): Response
    {
        return $this->render('front/maintenance/maintenance.html.twig');
    }

    #[Route('/evenements', name: 'app_evenements')]
    public function evenementsFront(): Response
    {
    ...
    public function userDetailsFront(int $id = null, UserRepository $userRepository, AnomalyService $anomalyService, ForecastService $forecastService): Response
    {
        if ($id === null) {
            $user = $this->getUser();
            if (!$user) {
    ...
    // --- BACK-END (formerly BackController) ---
    ...
    public function maintenanceBack(): Response
    {
    ...
    public function evenementsBack(): Response
    {
    ...
    public function ventesDepensesBack(Request $request, UserRepository $userRepository, VenteRepository $venteRepository, DepenseRepository $depenseRepository): Response
    {
        $searchTerm = $request->query->get('q');
        $filterRole = $request->query->get('role');
    ...
    public function userDetailsBack(int $id, UserRepository $userRepository, AnomalyService $anomalyService, ForecastService $forecastService): Response
    {
        $user = $userRepository->find($id);
